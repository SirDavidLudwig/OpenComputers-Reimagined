...
/**
 * This annotation can be used for methods in an {@link tech.dlii.opencomputers.api.network.Environment} to mark
 ...
 *
 * @see Context
 * @see tech.dlii.opencomputers.api.machine.Arguments
 */
...
public @interface Callback {
     ...
     * <br>
     * Keep in mind that the node {@link tech.dlii.opencomputers.api.network.Network} is <em>not</em> thread safe!
     ...
     * via a direct call to {@link tech.dlii.opencomputers.api.network.node.ComponentNode#invoke(String, Context, Object...)}
    ...
    /**
     * A documentation language key that is made available to the computers the
