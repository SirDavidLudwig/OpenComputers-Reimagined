package tech.dlii.opencomputers.api.network;
 ...
 * </ul>
 * <br>
 * See {@link Node} for more details on the behavior of single nodes, and in
...
public interface Network {
     ...
     * <br>
     * This does <em>not</em> include nodes with a visibility of {@link Visibility#None}
     * or a visibility of {@link Visibility#Neighbors} when there is no direct connection
     ...
     * <br>
     * This <em>does</em> include nodes with a visibility of {@link Visibility#None}
     * <br>
     * This does <em>not</em> include the node itself.
     * <br>
     ...
     * <br>
     * If the target node with that address has a visibility of {@link Visibility#None}
     * the message will <em>not</em> be delivered to that node. If the target
     * node with that address has a visibility of {@link Visibility#Neighbors} and the
