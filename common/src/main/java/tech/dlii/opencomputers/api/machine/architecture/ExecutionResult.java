 ...
 * {@link Architecture#runAsynchronous(boolean)}.
 * <br>
...
public abstract class ExecutionResult {
     ...
     * {@link Architecture#runAsynchronous(boolean)} will be called so that the next
     * signal is pushed.
     */
     ...
     * {@link Architecture#run()} instead of
     * {@link Architecture#runAsynchronous(boolean)}. This is used to perform calls
