...
public class Blocks {
    ...
    public static final RegistrySupplier<CaseBlock> CASE_1 = register("case_" + Tier.ONE, () -> new CaseBlock(Tier.ONE, baseProperties("case").mapColor(MapColor.METAL).sound(SoundType.METAL)));
    public static final RegistrySupplier<CaseBlock> CASE_2 = register("case_" + Tier.TWO, () -> new CaseBlock(Tier.TWO, baseProperties("case").mapColor(MapColor.METAL).sound(SoundType.METAL)));
    public static final RegistrySupplier<CaseBlock> CASE_3 = register("case_" + Tier.THREE, () -> new CaseBlock(Tier.THREE, baseProperties("case").mapColor(MapColor.METAL).sound(SoundType.METAL)));
