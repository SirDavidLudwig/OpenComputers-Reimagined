...
import li.cil.oc.util.StackOption.{EmptyStack, SomeStack}
...
//      EventHandler.scheduleClient(() => applyInventoryChanges())
  ...
  /**
   * @TODO Write capability handler things
   */
  //  override def hasCapability(capability: Capability[_], facing: Direction): Boolean = {
...
//  }
//
//  override def getCapability[T](capability: Capability[T], facing: Direction): T = {
//    val localFacing = this match {
//      case rotatable: Rotatable => rotatable.toLocal(facing)
//      case _ => facing
//    }
